...
const QuestionFormPage = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-50 dark:bg-gray-900 p-4">
      ...
      <div className="absolute top-0 left-0 w-64 h-64 bg-purple-100 dark:bg-purple-900/20 rounded-full filter blur-3xl opacity-30 -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-blue-100 dark:bg-blue-900/20 rounded-full filter blur-3xl opacity-30 translate-x-1/3 translate-y-1/3"></div>
      ...
      <div className="relative w-full max-w-4xl bg-white dark:bg-gray-800 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row border border-gray-100 dark:border-gray-700">
        ...
        <div className="md:w-24 bg-gray-100 dark:bg-gray-850 p-4 flex flex-col items-center justify-start md:border-r border-gray-100 dark:border-gray-700 shadow-[inset_-5px_0_10px_rgba(0,0,0,0.05)] dark:shadow-[inset_-5px_0_10px_rgba(0,0,0,0.2)]">
          <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white mb-6 shadow-[0_8px_15px_rgba(0,0,0,0.2)] dark:shadow-[0_8px_15px_rgba(0,0,0,0.4)]">
            <FaBrain className="text-xl drop-shadow-md" />
          </div>

          {/* Vertical Progress Steps */}
          <div className="relative flex-grow w-full flex flex-row md:flex-col items-center">
            {/* Vertical Line with shadow effect */}
            <div className="absolute left-5 md:left-1/2 md:transform md:-translate-x-1/2 top-0 bottom-0 w-0.5 bg-gray-300 dark:bg-gray-600 z-0 shadow-[0_0_5px_rgba(0,0,0,0.1)]"></div>
              ...
              {questions.map((_, idx) => (
                <button
                  ...
                  className={`flex items-center justify-center w-8 h-8 rounded-full transition-all 
                    ${
                      idx === currentIndex
                        ? "bg-gray-900 dark:bg-white text-white dark:text-gray-900 scale-110 shadow-[0_4px_12px_rgba(0,0,0,0.3)] dark:shadow-[0_4px_12px_rgba(255,255,255,0.2)]"
                        : responses[idx] !== null
